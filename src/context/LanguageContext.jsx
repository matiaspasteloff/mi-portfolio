...
const translations = {
    es: {
        ...
        projects: {
            ...
            subtitles: ['Motor de Videojuego RPG', 'E-commerce de Juegos'],
            descriptions: [
    ...
    en: {
        ...
        projects: {
            ...
            subtitles: ['RPG Video Game Engine', 'Games E-commerce'],
            descriptions: [
    ...
    pt: {
        ...
        projects: {
            ...
            subtitles: ['Motor de Videogame RPG', 'E-commerce de Jogos'],
            descriptions: [
