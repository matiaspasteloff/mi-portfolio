...
const translations = {
    es: {
        ...
        projects: {
            ...
            subtitles: ['Motor de Videojuego RPG', 'E-commerce de Juegos', 'Dashboard de Finanzas Personales', 'Diario de Lectura Social'],
            descriptions: [
                ...
                'Plataforma social de lectura estilo Letterboxd para libros. Backend con FastAPI y SQLAlchemy, frontend en React 19 con 8 temas visuales. Incluye reseñas, progreso de lectura, clubes de lectura, recomendaciones personalizadas con Google Books API, importación desde GoodReads y sistema de logros.',
            ],
        },
    ...
    en: {
        ...
        projects: {
            ...
            subtitles: ['RPG Video Game Engine', 'Games E-commerce', 'Personal Finance Dashboard', 'Social Reading Journal'],
            descriptions: [
                ...
                'A Letterboxd-style social reading platform for books. Backend with FastAPI and SQLAlchemy, React 19 frontend with 8 visual themes. Features reviews, reading progress, book clubs, personalized recommendations via Google Books API, GoodReads import, and an achievements system.',
            ],
        },
    ...
    pt: {
        ...
        projects: {
            ...
            subtitles: ['Motor de Videogame RPG', 'E-commerce de Jogos', 'Dashboard de Finanças Pessoais', 'Diário de Leitura Social'],
            descriptions: [
                ...
                'Plataforma social de leitura estilo Letterboxd para livros. Backend com FastAPI e SQLAlchemy, frontend em React 19 com 8 temas visuais. Inclui resenhas, progresso de leitura, clubes do livro, recomendações personalizadas via Google Books API, importação do GoodReads e sistema de conquistas.',
            ],
        },
    ...
    zh: {
        ...
        projects: {
            ...
            subtitles: ['RPG 游戏引擎', '游戏电商平台', '个人财务管理平台', '社交读书日记'],
            descriptions: [
                ...
                '类似Letterboxd的社交读书平台。后端采用FastAPI与SQLAlchemy，前端使用React 19并提供8种视觉主题。功能包括书评、阅读进度跟踪、读书俱乐部、基于Google Books API的个性化推荐、GoodReads导入以及成就系统。',
            ],
        },
        footer: { rights: '版权所有。' },
    },
